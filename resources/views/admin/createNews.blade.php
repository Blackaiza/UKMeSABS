<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto mt-8 px-6 py-4 bg-gray-800 text-gray-200 rounded-lg shadow-lg">
        <h1 class="text-2xl font-semibold mb-6">Create News</h1>
        ...
        <form action="{{ route('admin.storeNews') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="title" name="title" class="w-full px-4 py-2 bg-gray-900 text-gray-200 border border-gray-700 rounded-lg focus:ring focus:ring-blue-500 focus:outline-none" required>
            </div>

            <!-- Description -->
            <div class="mb-4">
                <label for="description" class="block text-sm font-medium mb-2">Description</label>
                <textarea id="description" name="description" rows="4" class="w-full px-4 py-2 bg-gray-900 text-gray-200 border border-gray-700 rounded-lg focus:ring focus:ring-blue-500 focus:outline-none" required></textarea>
            </div>

            <!-- Date -->
            <div class="mb-4">
                <label for="date" class="block text-sm font-medium mb-2">Date</label>
                <input type="date" id="date" name="date" class="w-full px-4 py-2 bg-gray-900 text-gray-200 border border-gray-700 rounded-lg focus:ring focus:ring-blue-500 focus:outline-none" required>
            </div>
