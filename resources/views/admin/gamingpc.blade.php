                    ...
                    <tbody>
                        @foreach ($seatsCount as $seat)
                            <tr class="border-b border-gray-600 hover:bg-gray-600 transition 
                                ...
                                <td class="py-4 px-6 text-white">{{ $seat->id }}</td>
                                <td class="py-4 px-6 text-white">{{ $seat->Facility->name }}</td>
                                <td class="py-4 px-6 text-white">{{ $seat->seat_number }}</td>
                                <td class="py-4 px-6 text-white">RM {{ number_format($seat->price, 2) }}</td>
                                <td class="py-4 px-6 text-white">{{ $seat->status }}</td>
