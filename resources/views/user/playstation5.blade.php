<x-app-layout>
    ...
    <body class="bg-gradient">
        <div class="form-container">
            <!-- Header Section -->
            <div class="header">
                <h2>PlayStation 5 - Selected Date: {{ $datetime }}</h2>
            ...
            <div class="seat-grid">
                <!-- PS5 Seats (A1 to A5) -->
                <div class="seat-box" data-seat="ps5a1" data-price="20">PS5-A1</div>
                <div class="seat-box" data-seat="ps5a2" data-price="25">PS5-A2</div>
                <div class="seat-box" data-seat="ps5a3" data-price="30">PS5-A3</div>
                <div class="seat-box" data-seat="ps5a4" data-price="35">PS5-A4</div>
                <div class="seat-box" data-seat="ps5a5" data-price="40">PS5-A5</div>
            </div>
