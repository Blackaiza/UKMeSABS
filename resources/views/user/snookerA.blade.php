<x-app-layout>
    <head>
        ...
        <style>
            ...
            .seat-grid {
                ...
                margin-top: 2rem;
                height: 200px;            /* Ensure the grid has enough height */
            }
    ...
    <body class="bg-gradient">
        <div class="form-container">
            <!-- Header Section -->
            <div class="header">
                <h2>Snooker A - Selected Date: {{ $datetime }}</h2>
            ...
            <div class="seat-grid">
                <!-- Snooker A Seat -->
                <div class="seat-box" data-seat="snookerA">Snooker A</div>
            </div>
        ...
        <script>
            ...
            seatBoxes.forEach(seat => {
                seat.addEventListener('click', () => {
                    ...
                    // Display the price
                    const price = "50";  // Assuming a fixed price for the seat, adjust as needed
